...
Note that the output from this command will be a .c file called ```SimpleScanner.c```. This file will contain the C language implementation of the Scanner which has been generated by ```flex```.
